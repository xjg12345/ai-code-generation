package com.xjg.aicodegeneration.config;
...
public class RedisCacheManagerConfig {
    ...
    public CacheManager cacheManager() {
        ...
        objectMapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS); // 解决 LocalDateTime 报错
        // 【核心】激活默认类型配置，告诉 Jackson 在序列化非 final 类时带上类型信息
