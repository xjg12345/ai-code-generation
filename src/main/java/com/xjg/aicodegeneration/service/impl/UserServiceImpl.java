...
import com.xjg.aicodegeneration.mapper.UserMapper;
import com.xjg.aicodegeneration.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>  implements UserService{
    ...
    @Override
    public long userRegister(String email, String userPassword, String checkPassword, String verificationCode) {
        // 1. 校验参数
        if (StrUtil.hasBlank(email, userPassword, checkPassword, verificationCode)) {
    ...
    public String getEncryptPassword(String userPassword) {
        // 盐值，混淆密码
        final String SALT = "xjg";
        // BCrypt 替代 MD5 加密，提高密码安全性
