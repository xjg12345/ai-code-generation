package com.xjg.aicodegeneration.ai.tools;
...
import com.xjg.aicodegeneration.langgraph4j.model.Enum.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    // https://undraw.co/_next/data/Drjj8o0PMGsZIMoiojT0v/search/happy.json?term=happy 获取插图失败的可以去抓取一下请求
