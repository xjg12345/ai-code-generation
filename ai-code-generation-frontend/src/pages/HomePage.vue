  ...
  <div id="homePage">
    <div class="container">
      ...
      <div class="hero-section">
        ...
        <p class="hero-description">一句话轻松创建前端应用</p>
      </div>
...
/* Decorative corner gradients - faint indigo / pink / teal */
#homePage::before {
  content: '';
  position: absolute;
  top: 0;
  ...
  bottom: 0;
  background:
    radial-gradient(ellipse 800px 600px at 10% 5%, rgba(56, 189, 248, 0.08) 0%, transparent 60%),
    radial-gradient(ellipse 700px 500px at 90% 10%, rgba(139, 92, 246, 0.06) 0%, transparent 60%),
    radial-gradient(ellipse 600px 500px at 80% 90%, rgba(20, 184, 166, 0.06) 0%, transparent 60%),
    radial-gradient(ellipse 500px 400px at 15% 85%, rgba(56, 189, 248, 0.05) 0%, transparent 60%);
  pointer-events: none;
  animation: auroraShift 14s ease-in-out infinite alternate;
}

/* Subtle light-gray grid pattern overlay */
...
/* Mouse follow soft warm glow (pink + indigo) */
#homePage::after {
  content: '';
  position: fixed;
  top: 0;
...
.hero-section::before {
  ...
  bottom: 0;
  background:
    radial-gradient(ellipse 800px 400px at center, rgba(56, 189, 248, 0.06) 0%, transparent 70%),
    radial-gradient(ellipse 600px 300px at center, rgba(139, 92, 246, 0.04) 0%, transparent 60%);
...
.hero-title {
  ...
  margin: 0 0 20px;
  line-height: 1.2;
  background: linear-gradient(135deg, #38bdf8 0%, #60a5fa 40%, #8b5cf6 100%);
...
/* Input section - white card with subtle shadow */
.input-section {
  position: relative;
  margin: 0 auto 24px;
  max-width: 800px;
...
/* Quick action buttons - white bg, light border, prismatic shimmer hover */
.quick-actions {
  display: flex;
  gap: 12px;
...
.quick-actions .ant-btn:hover {
  ...
  color: #38bdf8;
  transform: translateY(-2px);
  box-shadow: 0 6px 20px rgba(56, 189, 248, 0.1), 0 2px 8px rgba(139, 92, 246, 0.06);
}
